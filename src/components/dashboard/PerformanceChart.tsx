    ...
    <div className="bg-white rounded-2xl p-5 border border-gray-100">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-[14px] text-gray-400 mt-0.5">01 Jan – 31 Dec 2025</p>
        </div>
        <select className="text-[14px] border border-gray-200 rounded-lg px-3 py-1.5 text-gray-600 outline-none focus:border-brand-400">

  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-gray-100">
      <div className="flex items-center justify-between mb-4">
        ...
        <select className="text-[14px] border border-gray-200 rounded-lg px-2 py-1 text-gray-600 outline-none focus:border-brand-400">
      ...
      <div className="overflow-x-auto">
        ...
        <div className="flex justify-between mt-2">
          {months.map((m) => (
            <span key={m} className="text-[14px] text-gray-400">{m}</span>
          ))}
        </div>
      </div>
